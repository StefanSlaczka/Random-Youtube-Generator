/*
let words = ["cars", "football", "video games", "seal", "follow", "remain", "upset", "plan", "food", "shame", "mix", "cloudy", "house", "trees", "road", "ice", "reduce", "lying", "crook", "liquid"];
let find, name;
let length = words.length

function ReandomVideo(){
    find = Math.floor(Math.random() * length);
    found = words[find];
    link = 'https://www.youtube.com/results?search_query=' + found;
    location.href = link;
}*/

// https://gist.github.com/swenzel/70beac153cdf23803f89
// This is more intotive to do instead ading word by word
var grams = {
...
function ReandomVideo(n){
    ...
    link = 'https://www.youtube.com/results?search_query=' + words;
    location.href = link;;
}